...
PARAM$trainingstrategy$semilla_azar <- 100103 # Aqui poner su  primer  semilla -> Colocada la mia
...
PARAM$hyperparametertuning$semilla_azar <- 100189 #Cambiada por mi segunda semilla
#------------------------------------------------------------------------------
