...
parametros <- list('lag1a6', 'deltalag', 'rank', 'undersampling=0.5')

# Specify the file path (including the .txt extension)
file_path <- "./parametros.txt"

# Write the parameters to the .txt file using fwrite
fwrite(parametros, file = file_path, sep = "\t")

# Catastrophe Analysis  -------------------------------------------------------
# deben ir cosas de este estilo
#   dataset[foto_mes == 202006, active_quarter := NA]
#Calculo del zero_ratio
