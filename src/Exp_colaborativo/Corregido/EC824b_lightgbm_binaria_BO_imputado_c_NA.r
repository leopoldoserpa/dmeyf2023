...
metodo_imputacion <- "Zero_ratio_imputado_c_NA"
...
PARAM$finalmodel$optim$learning_rate <- 0.0580397434267233
PARAM$finalmodel$optim$feature_fraction <- 0.58747640981949
