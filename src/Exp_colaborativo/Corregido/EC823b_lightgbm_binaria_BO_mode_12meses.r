...
metodo_imputacion <- "mode_corregido_12meses"
...
PARAM$input$training <- c(202004, 202005, 202006, 202007, 202008, 202009,
...
taining_subset <- dataset[foto_mes %in% c(PARAM$input$training), ..campos_buenos]
...
# Chequeo nulos
sum(is.na(dataset[foto_mes %in% c(PARAM$input$training)]))
