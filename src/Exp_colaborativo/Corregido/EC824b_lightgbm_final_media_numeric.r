...
PARAM$finalmodel$optim$num_iterations <- 1484
PARAM$finalmodel$optim$learning_rate <- 0.047854792112577
PARAM$finalmodel$optim$feature_fraction <- 0.627254514884283
PARAM$finalmodel$optim$min_data_in_leaf <- 44035
