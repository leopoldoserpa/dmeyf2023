...
PARAM$semilla <- 100103 #CAMBIADA POR LA MIA
...
#setwd("~/buckets/leoserpa86/") # Establezco el Working Directory LO MODIFICO CON EL NOMBRE DE MI BUCKET?? SI LO CAMBIO NO PASA
