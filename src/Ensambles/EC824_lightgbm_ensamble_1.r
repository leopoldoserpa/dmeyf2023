...
PARAM$experimento <- "KA8240_ensamble_1"
...
PARAM$finalmodel$optim$num_iterations <- 1596
PARAM$finalmodel$optim$learning_rate <- 0.0206658974125037
PARAM$finalmodel$optim$feature_fraction <- 0.197788545354773
PARAM$finalmodel$optim$min_data_in_leaf <- 20017
PARAM$finalmodel$optim$num_leaves <- 321
PARAM$finalmodel$optim$neg_bagging_fraction <- 0.596351835425031
