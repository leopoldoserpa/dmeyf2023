...
ensamble_3 <- fread("exp/KA8240_ensamble_3/prediccion.csv", drop = c("numero_de_cliente","foto_mes"))
...
df <- cbind(ensamble_2, ensamble_3, ensamble_4)
...
for (envios in cortes) {
  ...
  fwrite(df[, list(numero_de_cliente, Predicted)],
         file = paste0("exp/ensamble_modelos/ensamble_2_3_4", "_", envios, ".csv"),
         sep = ","
  )
}
