...
PARAM$experimento <- "KA8240_ensamble_3"
...
PARAM$finalmodel$optim$num_iterations <- 1207
PARAM$finalmodel$optim$learning_rate <- 0.198110608580173
PARAM$finalmodel$optim$feature_fraction <- 0.548346487739618
PARAM$finalmodel$optim$min_data_in_leaf <- 37005
PARAM$finalmodel$optim$num_leaves <- 347
