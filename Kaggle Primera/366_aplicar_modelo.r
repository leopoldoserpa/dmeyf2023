...
PARAM$rpart$cp <- -1
PARAM$rpart$minsplit <- 1396
PARAM$rpart$minbucket <- 366
...
setwd("C:/Users/leopo/Desktop/Maestria DATA MINING/DMEyF") # Establezco el Working Directory
...
#dataset[, if_max_POS := ifelse((ctrx_quarter < 60) & (mpayroll < 7110.6) & (mpasivos_margen < 122.3), 1, 0)]
