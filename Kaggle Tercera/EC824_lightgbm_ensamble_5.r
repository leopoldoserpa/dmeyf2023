...
PARAM$experimento <- "KA8240_ensamble_5"

PARAM$input$dataset <- "./datasets/competencia_03_1.csv.gz"

# meses donde se entrena el modelo
PARAM$input$training <- c(202006, 202007,	202008,	202009,	202010,	202011,	202012,	
...
PARAM$finalmodel$optim$num_iterations <- 218
PARAM$finalmodel$optim$learning_rate <- 0.133442349178203
PARAM$finalmodel$optim$feature_fraction <- 0.319048639221909
PARAM$finalmodel$optim$min_data_in_leaf <- 2280
PARAM$finalmodel$optim$num_leaves <- 642
