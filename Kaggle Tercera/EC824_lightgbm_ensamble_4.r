...
PARAM$experimento <- "KA8240_ensamble_4"
...
PARAM$finalmodel$optim$num_iterations <- 1105
PARAM$finalmodel$optim$learning_rate <- 0.061964420219413
PARAM$finalmodel$optim$feature_fraction <- 0.580041308476695
PARAM$finalmodel$optim$min_data_in_leaf <- 12607
PARAM$finalmodel$optim$num_leaves <- 610
